    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-lg p-6 text-center py-16">
          ...
          <p className="text-sm text-[#666]">{cartError instanceof Error ? cartError.message : "Something went wrong"}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-lg p-6">
          <div className="flex flex-col items-center justify-center text-center">
            <div className="w-[120px] h-[120px] bg-[#fafafa] rounded-full flex items-center justify-center mb-2 border-2 border-dashed border-[#e0e0e0]">
              <ShoppingCart className="w-12 h-12 text-[#F9A922]" />
            </div>
            <h3 className="font-semibold text-[#333] text-[1.1rem] mb-2">Please Login to View Your Cart</h3>
            <p className="text-[#666] text-sm mb-8 max-w-[400px] leading-relaxed">
            ...
            <div className="flex gap-4 flex-wrap justify-center">
              <button onClick={() => router.push("/sign_in")} className="flex items-center gap-2 bg-[#F9A922] hover:bg-[#E8981F] text-white px-8 py-2 text-sm font-semibold rounded transition-colors min-w-[140px] justify-center">
                <LogIn className="w-4 h-4" /> Login
              </button>
              <button onClick={() => router.push("/sign_up")} className="border border-[#F9A922] text-[#F9A922] hover:bg-[rgba(249,169,34,0.04)] hover:border-[#E8981F] px-8 py-2 text-sm font-semibold rounded transition-colors min-w-[140px]">
                Sign Up
              </button>
            </div>
            <div className="mt-4 p-6 bg-[#fafafa] rounded max-w-[500px]">
          ...
          <div className="flex flex-col items-center justify-center py-16 px-8 text-center min-h-[60vh]">
            <div className="w-40 h-40 mb-8 relative" style={{ animation: "float 3s ease-in-out infinite" }}>
              <div className="w-full h-full rounded-[25px] border-[3px] border-dashed border-[#F9A922] flex items-center justify-center shadow-[0_12px_40px_rgba(255,107,53,0.15)]" style={{ background: "linear-gradient(135deg, #fff5f2 0%, #ffe8e0 100%)" }}>
                <ShoppingCart className="w-16 h-16 text-[#F9A922]" style={{ animation: "cartBounce 2s ease-in-out infinite" }} />
              </div>
            </div>
            <h2 className="text-[1.5rem] md:text-[2rem] font-semibold text-[#333] mb-4">Your Cart is Empty</h2>
            <p className="text-[#666] mb-8 max-w-[500px] text-sm md:text-[1.1rem] leading-relaxed">
              Add some amazing products to your cart and they will appear here. Start shopping to build your perfect order!
            </p>
            <button
              onClick={() => router.push("/product")}
              className="bg-[#F9A922] hover:bg-[#E8981F] text-white px-12 py-4 text-[1.1rem] font-semibold rounded-[12px] shadow-[0_6px_20px_rgba(255,107,53,0.3)] hover:shadow-[0_8px_30px_rgba(255,107,53,0.6)] hover:-translate-y-0.5 active:translate-y-0 transition-all"
            >
              Continue Shopping
            </button>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1">
          <div className="p-8 bg-gradient-to-br from-white to-[#f8fafc] rounded-xl border border-[#e2e8f0] shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
