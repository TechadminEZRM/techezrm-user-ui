...
const FeatureItem: React.FC<{ text: string; dimmed?: boolean }> = ({ text, dimmed }) => (
  <div className={`flex items-center gap-3 py-4 border-b border-line-light cursor-pointer transition-all hover:translate-x-2 ${dimmed ? "opacity-60" : ""}`}>
    <ArrowRight className={`w-6 h-6 shrink-0 ${dimmed ? "text-line-light" : "text-brand"}`} />
    <span className={`text-[1.1rem] md:text-[1.25rem] font-medium ${dimmed ? "text-faint" : "text-body"}`}>{text}</span>
  </div>
);
...
const DifferentiatorCard: React.FC<{ title: string; description: string; iconEl: React.ReactNode; colSpan?: string }> = ({ title, description, iconEl, colSpan }) => (
  <div className={`p-6 md:p-8 text-center transition-all hover:-translate-y-0.5 ${colSpan || ""}`}>
    <div className="w-15 h-15 mx-auto mb-6 flex items-center justify-center bg-surface rounded-card">
      {iconEl}
    </div>
    <h3 className="font-semibold text-body text-[1.1rem] md:text-[1.25rem] mb-3">{title}</h3>
    ...
    <div className="w-full">
        ...
        <div className="relative z-2 max-w-7xl mx-auto px-6 md:px-4 text-center">
          <div className="max-w-225 mx-auto flex flex-col items-center gap-8 md:gap-10">
            ...
            <Button
              ...
              className="bg-brand hover:bg-primary-hover text-white font-semibold text-base rounded-[50px] px-10 md:px-12 py-3 md:py-3 min-w-40 md:min-w-55 shadow-[0_4px_16px_rgba(255,107,53,0.3)] hover:shadow-[0_6px_20px_rgba(255,107,53,0.4)] hover:-translate-y-0.5 active:translate-y-0 transition-all"
            >
              Book a Call
            </Button>
          </div>
      ...
      <div className="w-full flex justify-center items-center py-8 md:py-12">
        <div className="w-[80%] flex flex-col md:flex-row shadow-[0_4px_20px_rgba(0,0,0,0.1)] rounded-card overflow-hidden md:h-screen">
          {/* Left - Core Services */}
          <div className="w-full md:w-1/2 bg-paper flex items-center py-12 md:py-16 px-6 md:px-12">
            <div className="max-w-125 mx-auto w-full">
              <h2 className="font-semibold text-body text-[2rem] md:text-[2.5rem] lg:text-[3rem] leading-tight tracking-tight mb-8 md:mb-12">
                Our <span className="text-brand">Core Services</span> &<br />Capabilities
              </h2>
      ...
      <div className="flex justify-center items-center bg-paper">
        <div className="w-[95%] py-12 md:py-20 px-6 md:px-8 bg-white m-6 rounded-[20px]">
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-20 mb-12 md:mb-16 text-left">
              <h2 className="font-semibold text-body text-[1.8rem] sm:text-[2.2rem] md:text-[1.5rem] leading-tight tracking-tight mb-6 md:mb-10 shrink-0">
                What Makes EZRM <span className="text-brand">Different</span> from others
              </h2>
              <p className="text-sm md:text-base text-dim leading-relaxed max-w-250">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
              <DifferentiatorCard
                ...
                iconEl={<div className="w-8 h-8 bg-brand rounded-lg relative before:content-[''] before:absolute before:w-4 before:h-0.5 before:bg-white before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 after:content-[''] after:absolute after:w-2 after:h-2 after:bg-white after:rounded-full after:top-1.5 after:right-1.5" />}
              />
              <DifferentiatorCard
                title="Advanced Manufacturing"
                description="Cutting-edge liposomal and microencapsulation technologies."
                iconEl={<div className="w-8 h-6 bg-brand rounded-xs relative before:content-[''] before:absolute before:w-1.5 before:h-1.5 before:bg-white before:rounded-[1px] before:top-1 before:left-1 after:content-[''] after:absolute after:w-4 after:h-0.5 after:bg-white after:rounded-[1px] after:bottom-1 after:left-1" />}
              />
              <DifferentiatorCard
                title="Integrated Supply Chain"
                description="Seamless manufacturing, warehousing, and distribution solutions."
                colSpan="sm:col-span-2 md:col-span-1"
                iconEl={<div className="w-8 h-5 bg-info rounded-xs relative before:content-[''] before:absolute before:w-2 before:h-2 before:bg-white before:rounded-full before:top-1/2 before:left-1 before:-translate-y-1/2 after:content-[''] after:absolute after:w-1 after:h-1 after:bg-brand after:rounded-full after:top-0.5 after:right-1" />}
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-200 mx-auto">
              <DifferentiatorCard
                ...
                iconEl={<div className="w-8 h-8 relative flex items-center justify-center"><div className="w-3 h-3 bg-brand rounded-full absolute" /><div className="w-6 h-6 border-2 border-brand rounded-full absolute" /><div className="w-0.5 h-2 bg-brand absolute top-0.5" /></div>}
              />
              <DifferentiatorCard
                title="Future-Forward Vision"
                description="Pioneering next-generation solutions for tomorrows challenges."
                iconEl={<div className="w-5 h-5 border-[3px] border-info rounded-full relative before:content-[''] before:absolute before:w-1.5 before:h-1.5 before:bg-info before:rounded-full before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 after:content-[''] after:absolute after:w-0.5 after:h-2 after:bg-info after:-top-2 after:left-1/2 after:-translate-x-1/2" />}
              />
            </div>
          </div>
        </div>
      ...
      {/* Who We Are Section */}
      <div className="w-full py-12 md:py-20 px-6 md:px-8 bg-paper">
        <div className="max-w-360 mx-auto flex flex-col lg:flex-row gap-8 lg:gap-0 items-stretch">
          ...
          <div className="w-full lg:w-1/2 flex flex-col lg:pl-8">
            <div className="bg-heading rounded-[20px] p-8 md:p-10 mb-6 flex-1 flex flex-col justify-center">
              <h3 className="font-semibold text-white text-[1.75rem] md:text-[2.25rem] lg:text-[2.5rem] leading-tight tracking-tight mb-6">
                WHO <span className="text-brand">WE</span> ARE ?
              </h3>
            ...
            <div className="bg-brand rounded-[20px] p-8 md:p-10 flex-1 flex flex-col justify-center">
