  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 py-6 max-w-[1200px] mx-auto">
        <h2 className="mb-3 font-bold text-body text-2xl">Mineral Activity and Solubility in Water</h2>
        <p className="mb-4 text-dim leading-relaxed">Elemental composition table for minerals. NB: Data here is lower or average values from calculated or published data and should be used as a guide only. Please contact our friendly and knowledgeable technical sales colleagues to help guide you to the best ingredients to allow you to achieve your desired mineral levels for your products.</p>

        <h3 className="mt-4 mb-3 font-bold text-body text-xl">Mineral Activity and Solubility Database</h3>
