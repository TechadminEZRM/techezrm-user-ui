  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 py-6 max-w-[1200px] mx-auto">
        <h2 className="mb-3 font-bold text-body text-2xl">European Vitamin, Mineral and Proximate Dietary Reference Values (DRV, NRV, RDA)</h2>
        <p className="mb-4 text-dim leading-relaxed">Dietary reference values (DRVs) is an umbrella term for a set of nutrient reference values (NRVs) that includes the average requirement (AR), the population reference intake (PRI), the adequate intake (AI) and the reference intake range for macronutrients (RI). These values guide professionals on the amount of a nutrient needed to maintain health in an otherwise healthy individual or group of people. DRVs also include the tolerable upper intake level (UL), which is the maximum amount of a nutrient that can be consumed safely over a long period of time.</p>
        <p className="mb-4 text-dim leading-relaxed">RDA's (Recommended Daily Allowance) were an old system and have now changed to NRV's. The values for RDA and NRV are exactly the same.</p>
        <p className="mb-6 text-dim leading-relaxed">Please contact our friendly and knowledgeable technical sales colleagues to help guide you to the best ingredients to allow you to achieve these recommended levels on your products.</p>

        <h3 className="mt-4 mb-3 font-bold text-body text-xl">Daily Reference Intakes for Vitamins and Minerals (Adults)</h3>
        <h4 className="mb-2 font-bold text-dim text-lg">Vitamins</h4>
        ...
        <h4 className="mb-2 font-bold text-dim text-lg">Minerals</h4>
        <div className="overflow-x-auto mb-6 shadow-md rounded-lg">
          <table className="w-full border-collapse bg-white">
            <thead><tr><TH>Nutrient</TH><TH>EU NRV</TH><TH>Units (mg or mcg)</TH><TH>IU</TH><TH>Standardised Units (mg)</TH><TH>Tolerable Upper Intake Level (UL) mg</TH></tr></thead>
            <tbody>
        ...
        <h3 className="mt-4 mb-3 font-bold text-body text-xl">Daily Reference Intakes for Energy and selected nutrients other than Vitamins and Minerals (Adults)</h3>
        <div className="overflow-x-auto mb-6 shadow-md rounded-lg">
          <table className="w-full border-collapse bg-white">
            ...
            <tbody>
              {[["Energy","2000 kcal"],["Energy","8400 kJ"],["Total fat","70 g"],["Saturates","20 g"],["Carbohydrate","260 g"],["Sugars","90 g"],["Protein","50 g"],["Salt","6 g"]]
                .map((r, i) => <tr key={i} className="border-b border-line-light hover:bg-gray-50"><TD>{r[0]}</TD><TD>{r[1]}</TD></tr>)}
            </tbody>
          </table>
        </div>

        <h3 className="mt-4 mb-3 font-bold text-body text-xl">Conversion factors for the calculation of Energy</h3>
        <div className="overflow-x-auto mb-6 shadow-md rounded-lg">
          <table className="w-full border-collapse bg-white">
        ...
        <h2 className="mt-6 mb-3 font-bold text-body text-2xl">Navigating Nutrient Needs: A Guide to Vitamin and Mineral Safety in Pregnancy in Europe</h2>
        <p className="mb-4 text-dim leading-relaxed">Ensuring adequate nutrition is paramount during pregnancy for the health of both mother and child. While meeting dietary requirements is crucial, it is equally important to be aware of the upper safe limits of vitamins and minerals to avoid potential harm. In Europe, the European Food Safety Authority (EFSA) provides guidance on these limits.</p>
        <p className="mb-4 text-dim leading-relaxed">Below is a comprehensive table detailing the EU Nutrient Reference Values (NRV) for the general adult population, alongside the Tolerable Upper Intake Levels (UL) established by EFSA that are applicable to expectant mothers.</p>

        <h3 className="mt-4 mb-3 font-bold text-body text-xl">Key Recommendations for Pregnancy:</h3>
        <div className="mb-4 flex flex-col gap-2">
          <p className="text-dim leading-relaxed"><strong>Folic Acid:</strong> Supplementation is crucial. It is recommended to take 400 µg of folic acid daily before conception and until the 12th week of pregnancy to reduce the risk of neural tube defects. In some cases, a higher dose may be prescribed.</p>
          <p className="text-dim leading-relaxed"><strong>Vitamin D:</strong> A daily supplement of 10 µg is recommended throughout pregnancy and breastfeeding, as it is difficult to obtain sufficient amounts from diet and sunlight alone.</p>
          <p className="text-dim leading-relaxed"><strong>Vitamin A (Retinol):</strong> High doses of Vitamin A can be teratogenic (cause birth defects). Therefore, pregnant individuals should avoid supplements containing high levels of vitamin A and limit consumption of liver and liver products.</p>
          <p className="text-dim leading-relaxed"><strong>Iron:</strong> While essential, the need for iron increases significantly during pregnancy and postnatally. However, any high-dose supplementation should only be taken under medical supervision, as excessive iron can cause gastrointestinal issues.</p>
        </div>
