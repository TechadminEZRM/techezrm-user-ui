  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold text-body mb-4">Get in Touch</h1>
        <p className="text-lg text-dim max-w-[600px] mx-auto leading-relaxed">
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center">
        ...
        <div className="w-full md:w-1/2">
          <div className="p-8 rounded-[16px] bg-surface h-fit">
            <h2 className="text-xl font-semibold text-body mb-6">Contact Information</h2>

            <div className="mb-8">
              <h3 className="text-base font-semibold text-brand mb-2">Address</h3>
            ...
            <div className="mb-8">
              <h3 className="text-base font-semibold text-brand mb-2">Phone</h3>
              <p className="text-dim leading-relaxed">
            ...
            <div className="mb-8">
              <h3 className="text-base font-semibold text-brand mb-2">Email</h3>
              <p className="text-dim leading-relaxed">
            ...
            <div>
              <h3 className="text-base font-semibold text-brand mb-2">Business Hours</h3>
              <p className="text-dim leading-relaxed">
